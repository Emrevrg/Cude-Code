...
// as assets/cude-mark.svg, reduced onto a quadrant-block grid by
// tools/generate-logo.mjs. Do not hand-edit: run `node tools/generate-logo.mjs
// --write` instead, so the mark and the artwork cannot drift apart.
const LOGO_ART =
  '             ▗▄███▄▖\n' +
  '          ▄▄█████████▄▄\n' +
  '       ▄▟████▛▀   ▀▜████▙▄\n' +
