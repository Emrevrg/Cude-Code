...
export const MODELS: Record<string, ModelDefinition> = {
  ...
  'gemini-2.5-pro': {
    ...
    free: false,
    local: false,
    capabilities: ['complex', 'code', 'analysis', 'reasoning', 'vision'],
    contextWindow: 1000000,
  },
  ...
  // Perplexity AI models (current API IDs as of 2025)
  'sonar-pro': {
    id: 'sonar-pro',
  ...
  'sonar-reasoning': {
    id: 'sonar-reasoning',
    name: 'Sonar Reasoning (Web + Think)',
    provider: 'perplexity',
    pricing: { inputPerMillion: 1, outputPerMillion: 5 },
    free: false,
    local: false,
    capabilities: ['research', 'reasoning', 'web'],
    contextWindow: 127072,
  },
  ...
  'glm-4-flash': {
    ...
    free: true,
    local: false,
    capabilities: ['quick', 'general', 'code'],
    contextWindow: 128000,
  },
  'glm-4-long': {
    id: 'glm-4-long',
    name: 'GLM-4 Long',
    provider: 'glm',
    pricing: { inputPerMillion: 0.14, outputPerMillion: 0.14 },
    free: false,
    local: false,
    capabilities: ['analysis', 'writing', 'general'],
    contextWindow: 1000000,
  ...
  // ─── Replicate ────────────────────────────────────────────────────────────
  'replicate/meta-llama-3.1-405b': {
    id: 'meta/meta-llama-3.1-405b-instruct',
    name: 'Llama 3.1 405B (Replicate)',
    provider: 'replicate',
    pricing: { inputPerMillion: 9.5, outputPerMillion: 9.5 },
    free: false,
    local: false,
    capabilities: ['code', 'complex', 'analysis', 'writing', 'general'],
    contextWindow: 128000,
  ...
  'huggingface/mistral-nemo': {
    ...
    name: 'Mistral Nemo (HuggingFace)',
    provider: 'huggingface',
    pricing: { inputPerMillion: 0, outputPerMillion: 0 },
    free: true,
    local: false,
    capabilities: ['code', 'general', 'writing'],
    contextWindow: 128000,
  },
